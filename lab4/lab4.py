"""
Данная программа выполняет поиск и удаление повторяющихся строк в текстовом файле.
...
"""Словарь замены для natural"""


def all(string: str):
    """ Замена похожих символов без учета регистра """
    string = string.lower()
...
def natural(string: str):
    """ Замена похожих символов с учётом регистра """
...
def find_del():
    """ Проверка условий, модификация файла с учетом условий"""
    with open(file, 'r', encoding="utf-8") as fp:
        ...
        for ln_index, ln in enumerate(data.split('\n', )):
            ...
            """Поиск уникальных Хэшей у строк, внесение уникальных значений хэшей и строк в списки"""
            if ln not in hashes:
                hashes.add(ln)
                unique.append(ln)
...
def save():
    """создание и сохранение отредактированного файла"""
    exp = input(
    ...
    if exp and not exp.isspace():
        ...
        """Вывод текста в консоль, если файл не создан"""
        for value in unique:
            print(value + '\n')
...
""" Выбор файла для работы из папки Examples и ввод модификаций """
